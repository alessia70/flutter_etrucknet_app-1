...
class RichiediPreventivoPage extends StatefulWidget {
  const RichiediPreventivoPage({super.key});

  @override
  _RichiediPreventivoPageState createState() => _RichiediPreventivoPageState();
}
